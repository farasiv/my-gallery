...
def get_year_and_album():
    """Helper to browse and select year and album folders."""
    # Select Year
...
def delete_images():
    ...
    # Path logic matching your current folder structure
    ...
    for item in images_data:
        # Extract number from 'photo_005.jpg'
...
def delete_album():
    ...
    try:
        ...
        print(f"🚀 Album fully removed. Please run your menu refresh script now.")
